...
$router->get('/formAdminhoteles',[HotelController::class, 'formadmin'], [HotelController::class, 'crearHotel']);
$router->post('/formAdminhoteles', [HotelController::class, 'crearHotel']);
